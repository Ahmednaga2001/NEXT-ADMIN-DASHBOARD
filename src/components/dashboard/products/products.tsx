    ...
    return (
        <section className="m-2 bg-primary text-white p-5 font-JanatLT">
            <div className="flex justify-between items-center">
                ...
                <Search/>
                <Link className="bg-blue-500 px-2 py-1 rounded-md hover:bg-white hover:text-black" href="/dashboard/products/addproduct">Add Product</Link>
                </div>
                        ...
                        <tbody>
                            <tr className="">
                                ...
                                <td className="p-3 text-sm">
                                    <Link href="/dashboard/products/id" className="bg-red-500 px-2 py-1 rounded-md">View</Link>
